...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'GlassfaceUser.profile_picture'
        raise RuntimeError("Cannot reverse this migration. 'GlassfaceUser.profile_picture' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GlassfaceUser.profile_picture'
        db.add_column(u'glassface_glassfaceuser', 'profile_picture',
                      self.gf('django_filepicker.models.FPFileField')(max_length=100),
                      keep_default=False)
